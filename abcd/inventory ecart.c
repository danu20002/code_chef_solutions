...
void addItem(){
 ...
 printf("\nEnter the code and quantity of
 the item to be added to your cart\n");
 scanf("%d%d",&c[itemNum].code,
 &c[itemNum].quantity);
 c[itemNum].cost=c[itemNum].quantity
 * stock[c[itemNum].code][2];
printf("\n The item with code %d is added to the cart\n",
c[itemNum].code);
printf("\n Your cart contains....\n ");
printf("\nItem code\tQuantity\t Total amount\n");
printf(" %d\t\t %d\t\t %5.2f", c[itemNum].code,
c[itemNum].quantity,
c[itemNum].cost);
